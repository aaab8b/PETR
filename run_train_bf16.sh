...
## normal config
CONFIG=${PWD}/projects/configs/petrv2/petrv2_vovnet_gridmask_p4_800x320_no_ckpt_bf16.py 
WORK_DIR=${PWD}/train_full_work_dirs_bf16
## profile config
...
tools/bf16/dist_train.sh $CONFIG 1 --work-dir ${WORK_DIR}
#WORK_DIR=${PWD}/profiler_logs
